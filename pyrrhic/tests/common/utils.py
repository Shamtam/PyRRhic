...
class TestBoundInt(unittest.TestCase):
    ...
    def test_uint8(self):
        ...
        self.assertEqual(bound_int(DataType.UINT8, -sys.maxsize), 0)
        self.assertEqual(bound_int(DataType.UINT8, sys.maxsize), 255)
    ...
    def test_uint16(self):
        ...
        self.assertEqual(bound_int(DataType.UINT16, -sys.maxsize), 0)
        self.assertEqual(bound_int(DataType.UINT16, sys.maxsize), 65535)
    ...
    def test_uint32(self):
        ...
        self.assertEqual(bound_int(DataType.UINT32, -sys.maxsize), 0)
        self.assertEqual(bound_int(DataType.UINT32, sys.maxsize), 4294967295)
    ...
    def test_int8(self):
        ...
        self.assertEqual(bound_int(DataType.INT8, -sys.maxsize), -128)
        self.assertEqual(bound_int(DataType.INT8, sys.maxsize), 127)
    ...
    def test_int16(self):
        ...
        self.assertEqual(bound_int(DataType.INT16, -sys.maxsize), -32768)
        self.assertEqual(bound_int(DataType.INT16, sys.maxsize), 32767)
    ...
    def test_int32(self):
        ...
        self.assertEqual(bound_int(DataType.INT32, -sys.maxsize), -2147483648)
        self.assertEqual(bound_int(DataType.INT32, sys.maxsize), 2147483647)
